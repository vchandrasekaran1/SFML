...
TEST_CASE("sf::Angle class - [system]")
{
    SUBCASE("Construction")
    {
        ...
        SUBCASE("wrappedTo180()")
        {
            CHECK(sf::Angle::Zero.wrappedTo180() == sf::Angle::Zero);
            CHECK(sf::degrees(0).wrappedTo180() == sf::degrees(0));
            CHECK(sf::degrees(1).wrappedTo180() == sf::degrees(1));
            CHECK(sf::degrees(-1).wrappedTo180() == sf::degrees(-1));
            CHECK(sf::degrees(90).wrappedTo180() == sf::degrees(90));
            CHECK(sf::degrees(-90).wrappedTo180() == sf::degrees(-90));
            CHECK(sf::degrees(180).wrappedTo180() == sf::degrees(-180));
            CHECK(sf::degrees(-180).wrappedTo180() == sf::degrees(-180));
            CHECK(sf::degrees(360).wrappedTo180() == sf::degrees(0));
            CHECK(sf::degrees(-360).wrappedTo180() == sf::degrees(0));
            CHECK(sf::degrees(720).wrappedTo180() == sf::degrees(0));
            CHECK(sf::degrees(-720).wrappedTo180() == sf::degrees(0));
        }

        SUBCASE("wrappedTo360()")
        {
            CHECK(sf::Angle::Zero.wrappedTo360() == sf::Angle::Zero);
            CHECK(sf::degrees(0).wrappedTo360() == sf::degrees(0));
            CHECK(sf::degrees(1).wrappedTo360() == sf::degrees(1));
            CHECK(sf::degrees(-1).wrappedTo360() == sf::degrees(359));
            CHECK(sf::degrees(90).wrappedTo360() == sf::degrees(90));
            CHECK(sf::degrees(-90).wrappedTo360() == sf::degrees(270));
            CHECK(sf::degrees(180).wrappedTo360() == sf::degrees(180));
            CHECK(sf::degrees(-180).wrappedTo360() == sf::degrees(180));
            CHECK(sf::degrees(360).wrappedTo360() == sf::degrees(0));
            CHECK(sf::degrees(-360).wrappedTo360() == sf::degrees(0));
            CHECK(sf::degrees(720).wrappedTo360() == sf::degrees(0));
            CHECK(sf::degrees(-720).wrappedTo360() == sf::degrees(0));
        }
